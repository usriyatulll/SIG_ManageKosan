...
<head>
    ...
    <title>SIG Manage Kosan | <?= $judul ?> </title>
...
<body>
    <nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
        <!-- Navbar Brand-->
        <a class="navbar-brand ps-3" href="<?= base_url('/Home') ?>">Manage Kosan</a>
        <!-- Sidebar Toggle-->
                ...
                <div class="sb-sidenav-menu">
                    <div class="nav">
                        ...
                        <a class="nav-link" href="<?= base_url('Lokasi/index') ?>">
                            <div class="sb-nav-link-icon"><i class="fa-solid fa-table"></i></div>Data Lokasi
                        </a>
            ...
            <footer class="py-4 bg-light mt-auto">
                <div class="container-fluid px-4">
                    <div class="d-flex align-items-center justify-content-between small">
                        <div class="text-muted">Copyright &copy; SIG 2023</div>
                    </div>
                </div>
            </footer>
        </div>
